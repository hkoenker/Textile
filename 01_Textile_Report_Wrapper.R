...
textile_cty_list <- list(
  ...
  # list(netfile="BFHR7A_netfile.dta", country="Burkina Faso"),
  # list(netfile="BUHR70_netfile.dta", country="Burundi"),
  # list(netfile="CDHR61_netfile.dta", country="DRC"),
  # list(netfile="CIHR62_netfile.dta", country="Cote d'Ivoire"),
  ...
  # list(netfile="GNHR71_netfile.dta", country="Guinea"),
  # list(netfile="KEHR81_netfile.dta", country="Kenya"),
  # list(netfile="LBHR7A_netfile.dta", country="Liberia"),
  # list(netfile="MDHR71_netfile.dta", country="Madagascar"),
  # list(netfile="MLHR7H_netfile.dta", country="Mali"),
  # list(netfile="MWHR7Q_netfile.dta", country="Malawi"),
  ...
  # list(netfile="TDHR71_netfile.dta", country="Chad"),
  list(netfile="TGHR71_netfile.dta", country="Togo"),
  # list(netfile="TZHR7Q_netfile.dta", country="Tanzania"),
  # list(netfile="UGHR7I_netfile.dta", country="Uganda"),
  # list(netfile="ZMHR71_netfile.dta", country="Zambia"),
  # list(netfile="ZWHR71_netfile.dta", country="Zimbabwe")
)
...
purrr::walk(textile_cty_list, function(file_info) {
  ...
  rmarkdown::render(
    "05_Textile_Results_Template.Rmd",
    output_file = paste0("doc/",country, "_Textile_Report.html"),
    params = list(netfile = netfile, country=country),
    envir = parent.frame())
})
