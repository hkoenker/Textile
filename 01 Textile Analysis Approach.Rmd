...
plot_coeffs <- function(mlr_model) {
      ...
      coeffs <- coeffs[2:24] # drop the intercept coefficient
      mp <- barplot(coeffs, col=c("orange","#3F97D0","gray","#3F97D0","#3F97D0","#3F97D0","#3F97D0","#3F97D0","gray","#3F97D0","gray","#3F97D0","gray","#3F97D0","gray","gray","gray","gray","gray","gray","gray","#3F97D0","gray"), xaxt='n', main="Regression Coefficients")
...
## Supposed to make a dot whisker plot with brackets around the groups of regions, SES, etc. doesn't work, error in grid.Call.graphics.
